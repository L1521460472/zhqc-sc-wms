 ...
 * @LastEditTime: 2021-11-02 11:26:55
 */
import service from '@/utils/server'
import { VUE_APP_OMS_MODEL } from '@/api/api.config.js'
const modName = VUE_APP_OMS_MODEL + '/transport/ruleDispatch/'
// 查询方法
...
// 启用
export const enableData = data => {
  return service({
    url: modName + 'enable/' + data,
    method: 'get'
  })
}
// 禁用
export const unableData = data => {
  return service({
    url: modName + 'deactivate/' + data,
    method: 'get'
  })
}
