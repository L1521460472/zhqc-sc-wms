...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.provinceName = null
      this.topForm.data.provinceCode = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.switchList = resp.obj.switchList
          this.listTypeInfo.enableTypeList = resp.obj.enableTypeList
          this.listTypeInfo.apiTypeList = resp.obj.apiTypeList
          this.listTypeInfo.enableList = resp.obj.isEnableList
        }
      })
    },
    /**
