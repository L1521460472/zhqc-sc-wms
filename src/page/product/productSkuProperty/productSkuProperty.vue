<template>
  <layout-body :key="freshKey">
    ...
    <div slot="right-btn">
      <!--  表格上面的导入导出按钮   -->
      <upload-vue style="display: inline-block" template-name="productSkuPropertyExcelImport" :disabled="hasPerm('import_excel')" />
      <export-vue
        style="display: inline-block"
        template-name="productSkuPropertyExcelExport"
        :export-name="exportName"
        export-url="/product/productSkuProperty/export"
        :check-param="true"
        :disabled="hasPerm('export_excel')"
        @exportParam="exportParam"
      />
      <export-template-vue style="display: inline-block" template-url="productSkuPropertyExcelTemplate" :export-name="templateExportName" :disabled="hasPerm('download_excel_template')" />
    </div>
...
<script>
import productSkuPropertyMixins from './mixins'
export default {
  name: 'ProductSkuProperty',
  mixins: [productSkuPropertyMixins],
  data() {
    return {
      store: 'productSkuProperty/',
      modName: 'productSkuProperty',
      exportName: this.$t('productSkuProperty.modelName'),
      templateExportName: this.$t('productSkuProperty.modelName') + this.$t('table.template'),
