...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.isDefault = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.isProductionBatchList = resp.obj.isProductionBatchList
          this.listTypeInfo.isProductionDateList = resp.obj.isProductionDateList
          this.listTypeInfo.isInstoreDateList = resp.obj.isInstoreDateList
          this.listTypeInfo.isInvalidDateList = resp.obj.isInvalidDateList
          this.listTypeInfo.isPoList = resp.obj.isPoList
          this.listTypeInfo.isAsnNoList = resp.obj.isAsnNoList
          this.listTypeInfo.isEnableList = resp.obj.isEnableList
          this.listTypeInfo.isDefaultList = resp.obj.isDefaultList
        }
      })
    },
    /**
