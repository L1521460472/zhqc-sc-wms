 ...
 * @LastEditTime: 2021-11-02 17:11:29
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="cpfrRuleService"
        :export-url="exportUrl"
        export-name="系统设置-补货规则表"
...
import cpfrRuleMixins from './mixins'
export default {
  name: 'CpfrRule',
  mixins: [cpfrRuleMixins],
  data() {
    return {
      store: 'cpfrRule/',
      modName: 'cpfrRule',
      formType: null,
      viewFlag: null,
      exportUrl: VUE_APP_WMS_MODEL + '/sys/cpfrRule/export',
