 ...
 * @LastEditTime: 2021-11-02 17:19:45
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <full-pop
      ...
      @handleClick="handleClick"
    >
      <full-pop-item full-pop-item-title="收货策略信息">
        <zhqc-form
      ...
      <full-pop-item full-pop-item-title="收货策略明细">
        <vex-dia-table
          ref="dtTable"
...
<script>
import recRuleMixins from './mixins'
export default {
  name: 'RecRule',
  components: {},
  mixins: [recRuleMixins],
  data() {
    return {
      store: 'recRule/',
      modName: 'recRule',
