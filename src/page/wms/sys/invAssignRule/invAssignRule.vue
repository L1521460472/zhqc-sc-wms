 ...
 * @LastEditTime: 2021-11-02 17:13:05
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <!--<export-vue templateName="invAssignRuleService"-->
      <!--exportUrl="sys/invAssignRule/export"-->
      <!--exportName="系统设置-库存分配策略表"-->
...
<script>
import invAssignRuleMixins from './mixins'
export default {
  name: 'InvAssignRule',
  mixins: [invAssignRuleMixins],
  data() {
    return {
      store: 'invAssignRule/',
      modName: 'invAssignRule',
      formType: null,
      viewFlag: null,
