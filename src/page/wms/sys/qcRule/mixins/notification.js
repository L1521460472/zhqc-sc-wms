...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.qcRuleCode = null
      this.topForm.data.qcRuleName = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.qcModeList = resp.obj.qcModeList
    ...
    handleQcModel(data) {
      if (data) {
        this.$set(this.diaFormInfo.data, 'checkRatio', null)
      }
      if (this.diaFormInfo.data.qcMode == 'CJ') {
        this.diaFormInfo.fieldList[3].disabled = false
      } else if (this.diaFormInfo.data.qcMode == 'MJ') {
        this.diaFormInfo.fieldList[3].disabled = true
        this.diaFormInfo.data.checkRatio = 0
      } else if (this.diaFormInfo.data.qcMode == 'QJ') {
        this.diaFormInfo.fieldList[3].disabled = true
        this.diaFormInfo.data.checkRatio = 100
      } else {
        this.diaFormInfo.fieldList[3].disabled = true
        this.diaFormInfo.data.checkRatio = null
      }
    }
