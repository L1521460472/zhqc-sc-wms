 ...
 * @LastEditTime: 2021-11-18 11:41:00
 */
import service from '@/utils/server'
import { VUE_APP_WMS_MODEL } from '@/api/api.config.js'
const modName = VUE_APP_WMS_MODEL + '/sys/paRule/'
const modName1 = VUE_APP_WMS_MODEL + '/base/wh/whZone/'
// 查询方法
...
// 停用
export const queryWhZoneList = () => {
  return service({
    url: modName1 + 'queryWhZoneList',
    method: 'post'
  })
}
