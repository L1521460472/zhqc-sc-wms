...
<template>
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <!--<export-vue templateName="paRuleService"-->
      <!--exportUrl="sys/paRule/export"-->
      <!--exportName="系统设置-上架规则表"-->
    ...
    <full-pop
      ...
      @handleClick="handleClick"
    >
      <full-pop-item full-pop-item-title="上架策略信息">
        <zhqc-form
      ...
      <full-pop-item full-pop-item-title="上架策略明细">
        <vex-dia-table
          ref="dtTable"
    ...
    >
      ...
      >
        <template v-slot:form-paZoneIdArray="scope">
          <el-select
            v-model="diaFormInfoDt.data.paZoneIdArray"
            filterable
            multiple
            clearable
            :disabled="!diaFormInfoDt.canEditZone"
            :collapse-tags="true"
          >
            <el-option
        ...
        <template v-slot:form-paLotIdArray="scope">
          <el-select
            v-model="diaFormInfoDt.data.paLotIdArray"
            filterable
            multiple
            clearable
            :disabled="!diaFormInfoDt.canEditLot"
            :collapse-tags="true"
          >
            <el-option
        ...
        <template v-slot:form-asnTypeArray="scope">
          <el-select v-model="diaFormInfoDt.data.asnTypeArray" clearable multiple :collapse-tags="true">
            <el-option
              v-for="item in listTypeInfo.asnTypeList"
              :key="item.value"
              :label="item.key"
              :value="item.value"
            />
        ...
        <template v-slot:form-lotTypeArray="scope">
          <el-select v-model="diaFormInfoDt.data.lotTypeArray" clearable multiple :collapse-tags="true">
            <el-option
              v-for="item in listTypeInfo.lotTypeList"
              :key="item.value"
              :label="item.key"
              :value="item.value"
            />
...
<script>
import paRuleMixins from './mixins'
export default {
  name: 'PaRule',
  components: {},
  mixins: [paRuleMixins],
