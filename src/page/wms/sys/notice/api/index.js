 ...
 * @LastEditTime: 2021-11-02 17:14:23
 */
import service from '@/utils/server'
import { VUE_APP_WMS_MODEL } from '@/api/api.config.js'
const modName = VUE_APP_WMS_MODEL + '/sys/notice/'
// 查询方法
...
export const publish = data => {
  return service({
    url: modName + 'publish/' + data.id,
    method: 'post'
  })
}
// 取消发布
export const cancelPublish = data => {
  return service({
    url: modName + 'cancelPublish/' + data.id,
    method: 'post'
  })
}
