import { pageInfo, initPage, initUpdate, saveData, editData, deleteData, enable, deactivate } from './../api'
import { message } from '../../../../../utils/messageUtils'

const invoiceOpenTicketSet = {
  namespaced: true,
  state: {
    successCode: 200,
    total: 0,
...
export default invoiceOpenTicketSet
