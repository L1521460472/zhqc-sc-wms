 ...
 * @LastEditTime: 2021-11-02 16:03:49
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      <export-vue
        template-name="invoiceDrawerSoRecordService"
    ...
    >
      ...
      <full-pop-item full-pop-item-title="发票明细">
        <vex-dia-table
          :ref-obj.sync="diaFormInfo.diaTableDt.ref"
          :data="diaFormInfo.data.dtList"
          :field-list="diaFormInfo.diaTableDt.fieldList"
          :handle="diaFormInfo.diaTableDt.handle"
          :top-btn="diaFormInfo.diaTableDt.topBtn"
          @handleClick="handleClick"
        />
      </full-pop-item>
    </full-pop>
...
import invoiceDrawerSoRecordMixins from './mixins'

export default {
  name: 'InvoiceDrawerSoRecord',
  mixins: [invoiceDrawerSoRecordMixins],
  data() {
    return {
      store: 'invoiceDrawerSoRecord/',
      modName: 'invoiceDrawerSoRecord',
      ...
      carrierCode: null,
      exportUrl: VUE_APP_WMS_MODEL + '/invoice/invoiceDrawerSoRecord/export'
    }
  },
  computed: {
