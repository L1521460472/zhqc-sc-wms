 ...
 * @LastEditTime: 2021-11-02 16:02:13
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      <el-button-group>
        <el-button icon="el-icon-folder-add" :disabled="$hasPerm('chongHong')" type="primary" @click="handleClick('batchChongHong')">批量冲红</el-button>
      </el-button-group>
    </div>
    ...
    <div slot="tab-body" class="tab-body_auto">
      ...
      >
        <template v-slot:col-status="scope">
          <el-button size="mini" type="danger" :disabled="$hasPerm('chongHong')" @click="chongHong(scope.row)">冲红</el-button>
        </template>
      </zhqc-table>
    </div>
...
import invoiceChongHongMixins from './mixins'

export default {
  name: 'InvoiceChongHong',
  mixins: [invoiceChongHongMixins],
  data() {
    return {
      store: 'invoiceChongHong/',
      modName: 'invoiceChongHong',
