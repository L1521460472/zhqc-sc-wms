import { pageInfo, initPage, initUpdate, saveData, editData, deleteData, drawer } from './../api'
...
const invoiceDrawer = {
  ...
  actions: {
    ...
    // 开票
    async drawer({ commit }, obj) {
      const resp = await drawer(obj)
      commit('DRAWER', resp)
    }
  }
}
