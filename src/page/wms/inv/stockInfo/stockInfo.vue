 ...
 * @LastEditTime: 2021-11-02 15:56:08
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      <!-- <el-button-group>
            ...
            <export-vue templateName="stockInfoService"
                        exportUrl="inv/stockInfo/export"
                        exportName="产品库存表"
...
<script>
import stockInfoMixins from './mixins'
export default {
  name: 'StockInfo',
  mixins: [stockInfoMixins],
  data() {
    return {
      store: 'stockInfo/',
      modName: 'stockInfo',
