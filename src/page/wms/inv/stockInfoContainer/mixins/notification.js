...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.sysSkuCode = null
      this.topForm.data.skuCode = null
      this.topForm.data.asnId = null
      this.topForm.data.asnNo = null
      this.topForm.data.lotCode = null
      this.topForm.data.containerNo = null
      this.topForm.data.batchNo = null
      this.topForm.data.stockQty = null
      this.topForm.data.usableQty = null
      this.topForm.data.allotQty = null
      this.topForm.data.frozenQty = null
      this.topForm.data.badQty = null
      this.topForm.data.instoreDate = null
