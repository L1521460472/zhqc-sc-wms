 ...
 * @LastEditTime: 2021-11-02 15:56:59
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      <!--<el-button-group>
            ...
            <export-vue templateName="stockTotalService"
                        exportUrl="inv/stockTotal/export"
                        exportName="库存总表"
...
<script>
import stockTotalMixins from './mixins'
export default {
  name: 'StockTotal',
  mixins: [stockTotalMixins],
  data() {
    return {
      store: 'stockTotal/',
      modName: 'stockTotal',
