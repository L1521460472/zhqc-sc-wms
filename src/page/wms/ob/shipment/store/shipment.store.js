import { pageInfo, initPage, initUpdate, saveData, editData, deleteData, initAdd, scanBox, deleteDt } from './../api'
...
const shipment = {
  ...
  actions: {
    ...
    // 扫描箱号事件
    async scanBox({ commit }, obj) {
      const resp = await scanBox(obj)
      commit('SCAN_BOX', resp)
    }
  }
}
