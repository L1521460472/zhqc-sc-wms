import { pageInfo, initPage, initUpdate, createWave } from './../api'
...
const soWave = {
  ...
  mutations: {
    ...
    CREATE_WAVE(state, data) {
      state.createWaveResp = data
    }
  ...
  actions: {
    ...
    // 生成波次
    async createWave({ commit }, obj) {
      const resp = await createWave(obj)
      commit('CREATE_WAVE', resp)
    }
  }
}
export default soWave
