import { deleteData, editData, initPage, initUpdate, pageInfo, saveData, abnormalHandle } from './../api'
import { message } from '../../../../../../utils/messageUtils'

const pickAbnormalHandle = {
  namespaced: true,
  state: {
    successCode: 200,
    total: 0,
  ...
  mutations: {
    ...
    ABNORMAL_HANDLE(state, data) {
      state.abnormalHandleResp = data
    }
  },
  actions: {
    // 查询事件
    ...
    // 异常处理
    async abnormalHandle({ commit }, obj) {
      const resp = await abnormalHandle(obj)
      commit('ABNORMAL_HANDLE', resp)
    }
  }
}
export default pickAbnormalHandle
