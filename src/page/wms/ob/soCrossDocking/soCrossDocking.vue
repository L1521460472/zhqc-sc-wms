 ...
 * @LastEditTime: 2021-11-02 16:09:42
-->
...
export default {
  ...
  data() {
    return {
      store: 'soCrossDocking/',
      modName: 'soCrossDocking',
      ...
      checkedIds: [],
      batchBtnArray: [
        { label: this.$t('soCrossDocking.assign'), type: 'success', icon: '', event: 'handleAssign', btLoading: false, show: !this.$hasPerm('assign'), disabled: true },
        { label: this.$t('soCrossDocking.cancelAssign'), type: 'danger', icon: '', event: 'handleCancelAssign', btLoading: false, show: !this.$hasPerm('cancelAssign'), disabled: true }
      ],
      dialogInfo: {
        title: '',
        visible: false,
