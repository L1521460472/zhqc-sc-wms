 ...
 * @LastEditTime: 2021-11-02 15:09:59
-->
<template>
  <layout-body>
    <div slot="top-form">
...
import carrierMixins from './mixins'
export default {
  name: 'Carrier',
  mixins: [carrierMixins],
  data() {
    return {
      store: 'carrier/',
      modName: 'carrier',
      formType: null,
      viewFlag: null,
      exportUrl: VUE_APP_WMS_MODEL + '/carrier/carrier/export',
