...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.orderPrice = null
      ...
      this.topForm.data.refundType = null
      this.topForm.data.refundReason = null
      this.topForm.data.sourceCode = null
      this.topForm.data.creator = null
      this.topForm.data.createTime = null
      this.topForm.data.rowNo = null
      this.topForm.data.sourceBatchNo = null
      this.topForm.data.orderQty = null
      this.topForm.data.asnDtStatus = null
      ...
      this.topForm.data.mainUnit = null
      this.topForm.data.mfg = null
      this.topForm.data.mfgId = null
      this.topForm.data.originCountry = null
      this.topForm.data.drugForm = null
      this.topForm.data.drugFormSpec = null
      this.topForm.data.itemQty = null
      this.topForm.data.skuQty = null
      this.topForm.data.amount = null
      this.topForm.data.aPrice = null
      this.topForm.data.vol = null
      this.topForm.data.grossWeight = null
      this.topForm.data.netWeight = null
      this.topForm.data.recPkgQty = null
      this.topForm.data.recQty = null
      this.topForm.data.rejectQty = null
      this.topForm.data.approveNo = null
      this.topForm.data.qcQty = null
      this.topForm.data.createTimeFrom = null
      this.topForm.data.createTimeTo = null
      this.topForm.data.asnStatus = null
      this.topForm.data.badQty = null
      this.topForm.data.goodQty = null
      this.topForm.data.paQty = null
    },
    /**
     * 翻页
     * @param val
