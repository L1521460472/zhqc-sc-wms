 ...
 * @LastEditTime: 2021-11-02 16:21:55
-->
<template>
  <layout-body>
    <div slot="top-form">
...
import qcReportMixins from './mixins'

export default {
  name: 'QcReport',
  mixins: [qcReportMixins],
  data() {
    return {
      store: 'qcReport/',
      modName: 'qcReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/ib/qcReport/export'
    }
  },
  computed: {
