 ...
 * @LastEditTime: 2021-11-02 16:18:11
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="gspRecheckInfoReportService"
        :export-url="exportUrl"
        export-name="复检明细记录导出"
...
import gspRecheckInfoReportMixins from './mixins'
...
export default {
  name: 'GspRecheckInfoReport',
  components: {
    listSkuCode, listOwner, listWhLot, listWhZone
  },
  mixins: [gspRecheckInfoReportMixins],
  data() {
    return {
      store: 'gspRecheckInfoReport/',
      modName: 'gspRecheckInfoReport',
      collapsable: false, // 展开收缩
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/gsp/gspRecheckInfoReport/export',
