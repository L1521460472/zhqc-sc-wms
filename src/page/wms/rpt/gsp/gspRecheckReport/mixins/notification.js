...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.recheckNo = null
      this.topForm.data.ownerName = null
      this.topForm.data.recheckDate = null
      this.topForm.data.frozenNo = null
      this.topForm.data.recheckStatus = null
      this.topForm.data.qcUserName = null
      this.topForm.data.maintainUserName = null
      this.topForm.data.creator = null
      this.topForm.data.createTime = null
      this.topForm.data.auditor = null
      ...
      this.topForm.data.recheckDateFrom = null
      this.topForm.data.recheckDateTo = null
      this.topForm.data.maintainUserNo = null
      this.topForm.data.qcUserNo = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.recheckStatusList = resp.obj.recheckStatusList
        }
      })
    },
    /**
