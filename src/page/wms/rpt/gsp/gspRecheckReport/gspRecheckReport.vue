 ...
 * @LastEditTime: 2021-11-02 16:18:37
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="gspRecheckReportService"
        :export-url="exportUrl"
        export-name="复检通知记录导出"
...
import gspRecheckReportMixins from './mixins'
...
export default {
  name: 'GspRecheckReport',
  components: {
    listSkuCode, listOwner, listWhLot, listWhZone
  },
  mixins: [gspRecheckReportMixins],
  data() {
    return {
      store: 'gspRecheckReport/',
      modName: 'gspRecheckReport',
      collapsable: false, // 展开收缩
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/gsp/gspRecheckReport/export',
