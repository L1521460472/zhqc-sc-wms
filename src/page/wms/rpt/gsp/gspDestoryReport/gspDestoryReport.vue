 ...
 * @LastEditTime: 2021-11-02 16:17:01
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="gspDestoryReportService"
        :export-url="exportUrl"
        export-name="销毁明细报表导出"
...
import gspDestoryReportMixins from './mixins'
import listSkuCode from '@/Subassembly/ZhqcList/ListSkuCode'
import listOwner from '@/Subassembly/ZhqcList/ListOwner'
export default {
  name: 'GspDestoryReport',
  components: {
    listSkuCode, listOwner
  },
  mixins: [gspDestoryReportMixins],
  data() {
    return {
      store: 'gspDestoryReport/',
      modName: 'gspDestoryReport',
      collapsable: false, // 展开收缩
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/gsp/gspDestoryReport/export',
