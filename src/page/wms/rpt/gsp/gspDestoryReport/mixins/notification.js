...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.badDestroyNo = null
      this.topForm.data.ownerName = null
      this.topForm.data.destroyTime = null
      this.topForm.data.status = null
      this.topForm.data.supervisorNo = null
      this.topForm.data.creator = null
      this.topForm.data.createTime = null
      this.topForm.data.reportNo = null
      ...
      this.topForm.data.destroyTimeFrom = null
      this.topForm.data.destroyTimeTo = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        // let resp = this.$store.state[this.modName].initPageObj;
        // if (resp.code === this.$store.state[this.modName].successCode) {
        //   this.listTypeInfo.ncrStatusList = resp.ncrStatusList;
        // }
      })
    },
    /**
