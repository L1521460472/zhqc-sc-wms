...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.ncrNo = null
      this.topForm.data.ownerName = null
      this.topForm.data.ncrDate = null
      this.topForm.data.recheckInfoNo = null
      this.topForm.data.ncrStatus = null
      ...
      this.topForm.data.ncrDateFrom = null
      this.topForm.data.ncrDateTo = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.ncrStatusList = resp.obj.ncrStatusList
        }
      })
    },
    /**
