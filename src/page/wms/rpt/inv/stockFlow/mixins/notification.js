...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.whName = null
      this.topForm.data.businessNo = null
      this.topForm.data.businessType = null
      this.topForm.data.stockChangeType = null
      this.topForm.data.formLotCode = null
      this.topForm.data.formBoxCode = null
      this.topForm.data.toLotCode = null
      this.topForm.data.toBoxCode = null
      this.topForm.data.batchNo = null
      this.topForm.data.skuId = null
      this.topForm.data.skuCode = null
      this.topForm.data.ownerSkuCode = null
      this.topForm.data.barcode = null
      this.topForm.data.ownerCode = null
      this.topForm.data.supplierCode = null
      this.topForm.data.toQty = null
      this.topForm.data.toBadQty = null
      this.topForm.data.remark = null
      this.topForm.data.operator = null
      this.topForm.data.operatTime = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        this.listTypeInfo.businessTypeList = this.$store.state[this.modName].initPageObj.businessTypeList
        this.listTypeInfo.stockChangeTypeList = this.$store.state[this.modName].initPageObj.stockChangeTypeList
      })
    },
    /**
     * 查询表格数据
