<template>
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="invMoAssignReportService"
        :export-url="exportUrl"
        export-name="加工领用明细报表"
...
import invMoAssignReportMixins from './mixins'
export default {
  name: 'InvMoAssignReport',
  mixins: [invMoAssignReportMixins],
  data() {
    return {
      store: 'invMoAssignReport/',
      modName: 'invMoAssignReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/inv/invMoAssignReport/export',
