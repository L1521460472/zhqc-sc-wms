 ...
 * @LastEditTime: 2021-11-02 16:45:30
-->
<template>
  <layout-body>
    <div slot="top-form">
      ...
      >
        <!-- 产品编码 -->
        <template v-slot:form-finishSkuCode="scope">
          <remote-list
            :model="topForm.data"
            select-key="finishSkuCode"
            lable="skuCode"
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="invMoFinishReportService"
        :export-url="exportUrl"
        export-name="加工完工明细报表"
...
import invMoFinishReportMixins from './mixins'
export default {
  name: 'InvMoFinishReport',
  mixins: [invMoFinishReportMixins],
  data() {
    return {
      store: 'invMoFinishReport/',
      modName: 'invMoFinishReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/inv/invMoFinishReport/export',
  ...
  methods: {
    selectSkuCode(data, obj) {
      this.topForm.data.finishSkuCode = obj.skuCode
    },
