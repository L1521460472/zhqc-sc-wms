...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.replenishDtStatus = null
      this.topForm.data.upShelfUser = null
      this.topForm.data.upShelfTime = null
      this.topForm.data.recommZoneId = null
      this.topForm.data.zoneId = null
      this.topForm.data.upShelfTimeFrom = null
      this.topForm.data.upShelfTimeTo = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.replenishDtStatusList = resp.obj.replenishDtStatusList
        }
      })
    },
    /**
