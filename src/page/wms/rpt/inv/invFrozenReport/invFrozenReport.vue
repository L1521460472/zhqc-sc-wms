...
<template>
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="invFrozenReportService"
        :export-url="exportUrl"
        export-name="库内库存冻结明细报表"
...
import invFrozenReportMixins from './mixins'
export default {
  name: 'InvFrozenReport',
  mixins: [invFrozenReportMixins],
  data() {
    return {
      store: 'invFrozenReport/',
      modName: 'invFrozenReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/inv/invFrozenReport/export',
