...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.downShelfType = null
      this.topForm.data.downShelfStatus = null
      ...
      this.topForm.data.operatorTime = null
      this.topForm.data.operatorTimeFrom = null
      this.topForm.data.operatorTimeTo = null
      this.topForm.data.zoneId = null
      this.topForm.data.recommZoneId = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.downShelfTypeList = resp.obj.downShelfTypeList
          this.listTypeInfo.downShelfStatusList = resp.obj.downShelfStatusList
        }
      })
    },
    /**
