 ...
 * @LastEditTime: 2021-11-02 16:27:34
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="invAdjReportService"
        :export-url="exportUrl"
        export-name="库存调整明细报表"
...
import invAdjReportMixins from './mixins'

export default {
  name: 'InvAdjReport',
  mixins: [invAdjReportMixins],
  data() {
    return {
      store: 'invAdjReport/',
      modName: 'invAdjReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/inv/invAdjReport/export',
