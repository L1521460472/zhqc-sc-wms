...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.planFinishTime = null
      this.topForm.data.actualFinishTime = null
      ...
      this.topForm.data.planFinishTimeFrom = null
      this.topForm.data.planFinishTimeTo = null
      this.topForm.data.actualFinishTimeFrom = null
      this.topForm.data.actualFinishTimeTo = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.moTypeList = resp.obj.moTypeList
          this.listTypeInfo.sourceTypeList = resp.obj.sourceTypeList
          this.listTypeInfo.moStatusList = resp.obj.moStatusList
        }
      })
    },
    /**
