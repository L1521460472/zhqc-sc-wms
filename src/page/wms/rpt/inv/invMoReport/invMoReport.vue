 ...
 * @LastEditTime: 2021-11-02 16:46:04
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="invMoReportService"
...
import invMoReportMixins from './mixins'

export default {
  name: 'InvMoReport',
  mixins: [invMoReportMixins],
  data() {
    return {
      store: 'invMoReport/',
      modName: 'invMoReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/inv/invMoReport/export',
  ...
  methods: {
    ...
    selectWhLot(data, obj) {
      this.topForm.data.moLotCode = obj.lotCode
    },
