 ...
 * @LastEditTime: 2021-11-02 16:28:15
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="inventoryReportService"
...
import inventoryReportMixins from './mixins'
export default {
  name: 'InventoryReport',
  mixins: [inventoryReportMixins],
  data() {
    return {
      store: 'inventoryReport/',
      modName: 'inventoryReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/inv/inventoryReport/export',
