...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.unfrozenNo = null
      this.topForm.data.ownerName = null
      this.topForm.data.sourceType = null
      this.topForm.data.unfrozenReason = null
      this.topForm.data.unfrozenStatus = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.unfrozenStatusList = resp.obj.unfrozenStatusList
          this.listTypeInfo.unfrozenReasonList = resp.obj.unfrozenReasonList
