...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.fmZoneCode = null
      this.topForm.data.fmLotCode = null
      this.topForm.data.toZoneCode = null
      this.topForm.data.toLotCode = null
      this.topForm.data.moveLotOrderStatus = null
      this.topForm.data.moveUserNo = null
      this.topForm.data.moveTime = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.moveLotOrderDtStatusList = resp.obj.moveLotOrderDtStatusList
        }
      })
    },
    /**
