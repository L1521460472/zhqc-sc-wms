 ...
 * @LastEditTime: 2021-11-02 17:01:52
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="maintainPlanRptService"
...
import maintainPlanRptMixins from './mixins'
...
export default {
  name: 'MaintainPlanRpt',
  components: {
    listOwner, listSku, listWhLot, listWhZone
  },
  mixins: [maintainPlanRptMixins],
  data() {
    return {
      store: 'maintainPlanRpt/',
      modName: 'maintainPlanRpt',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/maintain/maintainPlanRpt/export'
    }
  },
  computed: {
