...
const modName = VUE_APP_WMS_MODEL + '/rpt/ob/obShipmentReport/'
const modNameEPs = VUE_APP_WMS_MODEL + '/eps/logisticsRoute/etLogisticsRoute'
// 查询方法
...
export const etLogisticsRoute = data => {
  return service({
    url: modNameEPs,
    method: 'post',
    data
