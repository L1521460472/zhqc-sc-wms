 ...
 * @LastEditTime: 2021-11-02 17:04:32
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="obShipmentReportService"
        :export-url="exportUrl"
        export-name="发运交接明细导出"
...
import zhqcStep from '@/Subassembly/ZhqcStep'
import obShipmentReportMixins from './mixins'

export default {
  name: 'ObShipmentReport',
  components: {
    zhqcStep
  },
  mixins: [obShipmentReportMixins],
  data() {
    return {
      store: 'obShipmentReport/',
      modName: 'obShipmentReport',
  ...
  computed: {
    ...
    routeResp() { return this.$store.state[this.modName].routeResp }
  },
  watch: {
    // 监听弹窗的状态 清除校验与初始化字段
