...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.waveCreator = null
      this.topForm.data.waveCreateTime = null
      ...
      this.topForm.data.partnerName = null
      ...
      this.topForm.data.waveCreateTimeFrom = null
      this.topForm.data.waveCreateTimeTo = null
    },
    /**
     * 翻页
     * @param val
