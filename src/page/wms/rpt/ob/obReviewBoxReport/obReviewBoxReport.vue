 ...
 * @LastEditTime: 2021-11-02 17:04:03
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    <div slot="top-form">
      ...
      >
        ...
        <template v-slot:form-partnerId="scope">
          <list-partner :select-key="topForm.data.partnerId" :partner-type="carrierCode" @select="selectPartner" />
        </template>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="obReviewBoxReportService"
...
import obReviewBoxReportMixins from './mixins'
...
export default {
  name: 'ObReviewBoxReport',
  components: {
    listOwner, listCustomer, listPartner, listSkuCode
  },
  mixins: [obReviewBoxReportMixins],
  data() {
    return {
      store: 'obReviewBoxReport/',
      modName: 'obReviewBoxReport',
      collapsable: false, // 展开收缩
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/ob/obReviewBoxReport/export',
