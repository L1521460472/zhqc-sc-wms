 ...
 * @LastEditTime: 2021-11-02 17:05:00
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="obSoReportService"
        :export-url="exportUrl"
        export-name="SO明细报表导出"
...
import obSoReportMixins from './mixins'

export default {
  name: 'ObSoReport',
  mixins: [obSoReportMixins],
  data() {
    return {
      store: 'obSoReport/',
      modName: 'obSoReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/ob/obSoReport/export',
