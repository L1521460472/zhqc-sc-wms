...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.generateTime = null
      this.topForm.data.taxpayerName = null
      this.topForm.data.customerName = null
      this.topForm.data.invoiceStatus = null
      this.topForm.data.drawer = null
      this.topForm.data.payee = null
      this.topForm.data.reviewer = null
      this.topForm.data.skuCode = null
      this.topForm.data.generateTimeFrom = null
      this.topForm.data.generateTimeTo = null
    },
    /**
     * 翻页
     * @param val
