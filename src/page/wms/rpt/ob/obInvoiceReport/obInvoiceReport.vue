 ...
 * @LastEditTime: 2021-11-02 17:02:56
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="obInvoiceReportService"
...
import obInvoiceReportMixins from './mixins'
import listSkuCode from '@/Subassembly/ZhqcList/ListSkuCode'
export default {
  name: 'ObInvoiceReport',
  components: {
    listSkuCode
  },
  mixins: [obInvoiceReportMixins],
  data() {
    return {
      store: 'obInvoiceReport/',
      modName: 'obInvoiceReport',
      collapsable: false, // 展开收缩
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/ob/obInvoiceReport/export',
