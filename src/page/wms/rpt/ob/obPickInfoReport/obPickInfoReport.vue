 ...
 * @LastEditTime: 2021-11-02 17:03:26
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    <div slot="top-form">
      ...
      >
        ...
        <template v-slot:form-partnerId="scope">
          ...
          >
            <template v-slot="s">
              <span style="float: left; color: #8492a6; font-size: 13px;">{{ s.item.fullName }}</span>
            </template>
          </remote-list>
        </template>
        <!-- 产品编码 -->
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="obPickInfoReportService"
        :export-url="exportUrl"
        export-name="拣货明细报表导出"
...
import obPickInfoReportMixins from './mixins'

export default {
  name: 'ObPickInfoReport',
  mixins: [obPickInfoReportMixins],
  data() {
    return {
      store: 'obPickInfoReport/',
      modName: 'obPickInfoReport',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/rpt/ob/obPickInfoReport/export',
