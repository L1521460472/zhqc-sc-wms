...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.carrierName = null
      this.topForm.data.shopOrderNo = null
      this.topForm.data.waybillNo = null
      this.topForm.data.packingCheckerPerson = null
      this.topForm.data.weighingPerson = null
      this.topForm.data.deliveryTimeBegin = null
      this.topForm.data.deliveryTimeEnd = null
