 ...
 * @LastEditTime: 2021-11-02 17:06:35
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      <export-vue
        template-name="deliveryMonitoringRptService"
        export-url="statistics/deliveryMonitoringRpt/export"
        export-name="物流对账表"
...
<script>
import deliveryMonitoringRptMixins from './mixins'
...
export default {
  name: 'DeliveryMonitoringRpt',
  components: {
    listPartner, ZhqcListStore, ZhqcSummaryTable
  },
  mixins: [deliveryMonitoringRptMixins],
  data() {
    return {
      store: 'deliveryMonitoringRpt/',
      modName: 'deliveryMonitoringRpt',
      carrierCode: 'CARRIER',
