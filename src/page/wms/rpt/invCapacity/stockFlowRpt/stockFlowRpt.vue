<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="stockFlowRptService"
...
import stockFlowRptMixins from './mixins'

export default {
  name: 'StockFlowRpt',
  mixins: [stockFlowRptMixins],
  data() {
    return {
      store: 'stockFlowRpt/',
      modName: 'stockFlowRpt',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/invCapacity/stockFlowRpt/export'
    }
  },
  computed: {
