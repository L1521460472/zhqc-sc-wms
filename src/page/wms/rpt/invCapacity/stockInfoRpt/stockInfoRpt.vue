 ...
 * @LastEditTime: 2021-11-08 10:47:29
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      <export-vue
        template-name="stockInfoRptService"
    ...
    <div slot="tab-body" class="tab-body_auto">
      ...
      <zhqc-table
        ...
        @handleClick="handleClick"
      >
        <template v-slot:col-deliveryNode="scope">
          <!-- {{ scope }}
          77223 -->
          <div :class="{'link': isLink(scope.row) }" @click="operationDescClick(scope.row)">{{ scope.row.deliveryNode }}</div>
        </template>
      </zhqc-table>
    </div>
...
import stockInfoRptMixins from './mixins'
...
export default {
  ...
  mixins: [stockInfoRptMixins],
  data() {
    return {
      store: 'stockInfoRpt/',
      modName: 'stockInfoRpt',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/invCapacity/stockInfoRpt/export',
      sumsData: {
        grossWeightTon: 0,
        usableQty: 0,
        allotQty: 0,
