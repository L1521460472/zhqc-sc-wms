 ...
 * @LastEditTime: 2021-11-02 16:59:14
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      <export-vue
        template-name="safetyStockWarnRptService"
...
import safetyStockWarnRptMixins from './mixins'

export default {
  name: 'SafetyStockWarnRpt',
  mixins: [safetyStockWarnRptMixins],
  data() {
    return {
      store: 'safetyStockWarnRpt/',
      modName: 'safetyStockWarnRpt',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/invCapacity/safetyStockWarnRpt/export'
    }
  },
  computed: {
