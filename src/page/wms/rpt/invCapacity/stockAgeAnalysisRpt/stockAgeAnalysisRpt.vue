 ...
 * @LastEditTime: 2021-11-02 16:59:45
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      <export-vue
        template-name="stockAgeAnalysisRptService"
...
import stockAgeAnalysisRptMixins from './mixins'

export default {
  name: 'StockAgeAnalysisRpt',
  mixins: [stockAgeAnalysisRptMixins],
  data() {
    return {
      store: 'stockAgeAnalysisRpt/',
      modName: 'stockAgeAnalysisRpt',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/invCapacity/stockAgeAnalysisRpt/export'
    }
  },
  computed: {
