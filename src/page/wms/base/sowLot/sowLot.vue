 ...
 * @LastEditTime: 2021-11-02 14:42:29
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      <!--  <el-button-group>
            ...
            <export-vue templateName="sowLotService"
                        exportUrl="tm/sowLot/export"
                        exportName="基础管理-播种位档案"
    ...
    <full-pop
      ...
      @handleClick="handleClick"
    >
      <full-pop-item full-pop-item-title="播种容器">
        <zhqc-form
      ...
      <full-pop-item full-pop-item-title="播种位">
        <vex-dia-table
...
<script>
import sowLotMixins from './mixins'
export default {
  name: 'SowLot',
  mixins: [sowLotMixins],
  data() {
