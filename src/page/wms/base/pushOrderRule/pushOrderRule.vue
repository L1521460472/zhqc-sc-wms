 ...
 * @LastEditTime: 2021-11-02 14:39:26
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <full-pop
      ...
      @handleClick="handleClick"
    >
      <full-pop-item :full-pop-item-title="$t('pushOrderRule.info')">
        <zhqc-form
      ...
      <full-pop-item :full-pop-item-title="$t('pushOrderRule.detailed')">
