...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.deviceCode = null
      this.topForm.data.deviceName = null
      this.topForm.data.deviceTypeId = null
      this.topForm.data.brand = null
      this.topForm.data.deviceModel = null
      this.topForm.data.purchaseDate = null
      this.topForm.data.loadWeight = null
      this.topForm.data.workHeight = null
      this.topForm.data.ipAddr = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        this.listTypeInfo.whetherList = this.$store.state[this.modName].initPageObj.whetherList
        this.listTypeInfo.deviceTypeList = this.$store.state[this.modName].initPageObj.deviceTypeList
      })
    },
    /**
     * 查询表格数据
