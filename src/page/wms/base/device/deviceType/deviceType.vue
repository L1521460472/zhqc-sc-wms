 ...
 * @LastEditTime: 2021-11-02 14:25:09
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="deviceTypeService"
...
import deviceTypeMixins from './mixins'
export default {
  name: 'DeviceType',
  ...
  data() {
    return {
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/device/deviceType/export'
    }
  },
  computed: {
