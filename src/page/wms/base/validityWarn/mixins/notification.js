...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.validityDay = null
      this.topForm.data.warmValidityDay = null
      this.topForm.data.inWhValidity = null
      this.topForm.data.outWhValidity = null
     ...
     */
    deleteData(data) {
      this.$confirm(this.$t('确定要删除当前有效期预警设置信息吗？'), {
        type: 'warning',
        center: true
      }).then(() => {
