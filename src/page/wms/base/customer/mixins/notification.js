  ...
  methods: {
    ...
    queryRowData(data) {
      this.$store.dispatch(this.store + 'initUpdate', data.id).then(() => {
        ...
        this.diaFormInfo.diaFormInfoControl.data = this.$store.state[this.modName].initUpdateObj.control
    ...
    saveData() {
      this.diaFormInfo.ref.validate(valid => {
        if (valid) {
          const cusObj = this.diaFormInfo.data
          cusObj.controlReq = this.diaFormInfo.diaFormInfoControl.data
          this.$store.dispatch(this.store + 'saveData', cusObj).then(() => {
    ...
    editData() {
      this.diaFormInfo.ref.validate(valid => {
        if (valid) {
          const cusObj = this.diaFormInfo.data
          cusObj.controlReq = this.diaFormInfo.diaFormInfoControl.data
          this.$store.dispatch(this.store + 'editData', cusObj).then(() => {
