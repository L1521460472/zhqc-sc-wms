...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.areaCode = null
      this.topForm.data.areaName = null
      this.topForm.data.ownerCode = null
      this.topForm.data.ownerName = null
      this.topForm.data.tcType = null
      this.topForm.data.structureType = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.areaTypeList = resp.obj.areaTypeList
          this.listTypeInfo.tcTypeList = resp.obj.tcTypeList
          this.listTypeInfo.structureTypeList = resp.obj.structureTypeList
          this.listTypeInfo.enableList = resp.obj.enableList
          this.listTypeInfo.whList = resp.obj.whList
        }
      })
    },
    /**
