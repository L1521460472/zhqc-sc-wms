<template>
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="containerTypeService"
    ...
    >
      ...
      >
        <template v-slot:form-click>
          <el-checkbox v-model="isHaveLattice" @change="isHaveLatticeChecked" />
        </template>
      </zhqc-form>
    </zhqc-dialog>
  </layout-body>
...
import containerTypeMixins from './mixins'
export default {
  name: 'ContainerType',
  mixins: [containerTypeMixins],
  data() {
    return {
      store: 'containerType/',
      modName: 'containerType',
      formType: null,
      viewFlag: null,
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/base/tm/containerType/export'
    }
  },
  computed: {
