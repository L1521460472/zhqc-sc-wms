...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.zoneName = null
      this.topForm.data.zoneType = null
      this.topForm.data.storageType = null
      this.topForm.data.useScenes = null
      this.topForm.data.packageAttr = null
      this.topForm.data.abcType = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.tcTypeList = resp.obj.tcTypeList
          this.listTypeInfo.zoneTypeList = resp.obj.zoneTypeList
          this.listTypeInfo.fclReplenisOriginList = resp.obj.fclReplenisOriginList
          this.listTypeInfo.scatteredReplenisOriginList = resp.obj.scatteredReplenisOriginList
