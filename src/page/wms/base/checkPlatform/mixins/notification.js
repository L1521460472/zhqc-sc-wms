...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.checkPlatformCode = null
      this.topForm.data.checkPlatformName = null
      this.topForm.data.checkPlatformType = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        this.listTypeInfo.checkPlatformTypeList = this.$store.state[this.modName].initPageObj.checkPlatformTypeList
      })
    },
    /**
     * 查询表格数据
