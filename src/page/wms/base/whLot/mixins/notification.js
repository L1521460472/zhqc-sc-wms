...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.lotName = null
      this.topForm.data.lotStatus = null
      this.topForm.data.lotType = null
      this.topForm.data.lotCategory = null
      this.topForm.data.storageType = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.lotCategoryList = resp.obj.lotCategoryList
          this.listTypeInfo.lotTypeList = resp.obj.lotTypeList
          this.listTypeInfo.lotStatusList = resp.obj.lotStatusList
          this.listTypeInfo.enableList = resp.obj.enableList
          this.listTypeInfo.isMixProductList = resp.obj.isMixProductList
          this.listTypeInfo.isMixBatchList = resp.obj.isMixBatchList
          this.listTypeInfo.isMixProductionBatchList = resp.obj.isMixProductionBatchList
          this.listTypeInfo.abcTypeList = resp.obj.abcTypeList
          this.listTypeInfo.scatteredPropertiesList = resp.obj.scatteredPropertiesList
          this.listTypeInfo.packageAttrList = resp.obj.packageAttrList
          this.listTypeInfo.storageTypeList = resp.obj.storageTypeList
          this.listTypeInfo.qualityList = resp.obj.qualityList
          this.listTypeInfo.turnoverLevelList = resp.obj.turnoverLevelList
          this.listTypeInfo.wklxList = resp.obj.wklxList
        }
      })
    },
    /**
    ...
    queryRowData(data) {
      this.$store.dispatch(this.store + 'initUpdate', data.id).then(() => {
        ...
        this.areaId = this.diaFormInfo.data.areaId
        this.zoneId = this.diaFormInfo.data.zoneId
        this.dicTypeCode = this.diaFormInfo.data.zoneType
