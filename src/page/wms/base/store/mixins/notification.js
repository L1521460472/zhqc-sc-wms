...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.storeCode = null
      this.topForm.data.origCode = null
      this.topForm.data.shortName = null
      this.topForm.data.storeType = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.storeTypeList = resp.obj.storeTypeList
          this.listTypeInfo.ownerSystemList = resp.obj.ownerSystemList
          ...
          this.listTypeInfo.ownerPlatformList = resp.obj.ownerPlatformList
          this.listTypeInfo.shipTypeList = resp.obj.shipTypeList
          this.listTypeInfo.isEnableList = resp.obj.isEnableList
          this.listTypeInfo.isPrintMoneyList = resp.obj.isPrintMoneyList
        }
      })
    },
    /**
