 ...
 * @LastEditTime: 2021-11-02 14:38:08
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      <el-button-group>
        <el-button icon="el-icon-folder-add" type="primary" :disabled="$hasPerm('add')" @click="handleClick('openAddPage')">{{ $t('table.add') }}</el-button>
      </el-button-group>
      <export-vue
        template-name="payMapService"
        :export-url="exportUrl"
        export-name="平台付款方式映射表"
...
import payMapMixins from './mixins'
export default {
  name: 'PayMap',
  mixins: [payMapMixins],
  data() {
    return {
      store: 'payMap/',
      modName: 'payMap',
      exportUrl: VUE_APP_WMS_MODEL + '/base/tm/payMap/export',
