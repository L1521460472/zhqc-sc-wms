...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.formCode = null
      this.topForm.data.erpPayCode = null
      this.topForm.data.erpPayName = null
      this.topForm.data.payCode = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          this.listTypeInfo.formList = resp.obj.formList
          this.listTypeInfo.payCodeList = resp.obj.payCodeList
