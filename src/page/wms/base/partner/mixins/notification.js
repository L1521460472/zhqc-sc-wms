...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.partnerCode = null
      this.topForm.data.origCode = null
      this.topForm.data.shortName = null
      this.topForm.data.fullName = null
      this.topForm.data.partnerType = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.partnerTypeList = resp.obj.partnerTypeList
