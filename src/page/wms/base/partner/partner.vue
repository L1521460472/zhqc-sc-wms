 ...
 * @LastEditTime: 2021-11-02 14:34:06
-->
<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <layout-body>
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="partnerService"
        export-url="base/partner/partner/export"
        export-name="伙伴基础表"
...
<script>
import partnerMixins from './mixins'
