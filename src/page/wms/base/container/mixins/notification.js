...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.containerCode = null
      this.topForm.data.containerName = null
      this.topForm.data.containerTypeId = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.useStatusList = resp.obj.useStatusList
