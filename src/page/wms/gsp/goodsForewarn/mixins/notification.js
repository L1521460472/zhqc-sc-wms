...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.validityDateStart = null
      this.topForm.data.validityDateEnd = null
      this.topForm.data.productionDateStart = null
      this.topForm.data.productionDateEnd = null
    },
    /**
     * 翻页
     * @param val
