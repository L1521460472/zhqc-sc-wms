<template>
  <layout-body>
    ...
    <full-pop
      ...
      @handleClick="handleClick"
    >
      <full-pop-item full-pop-item-title="质量复查通知">
        <zhqc-form
...
import recheckMixins from './mixins'
export default {
  name: 'Recheck',
  components: {
    zhqcListOwner, buttonList
  },
  mixins: [recheckMixins],
  data() {
    return {
      store: 'recheck/',
      modName: 'recheck',
      ...
      exportUrl: VUE_APP_WMS_MODEL + '/gsp/recheck/export'
    }
  },
  computed: {
