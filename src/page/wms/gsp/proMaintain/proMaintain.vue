 ...
 * @LastEditTime: 2021-11-02 15:17:23
-->
<template>
  <layout-body>
    <div slot="top-form">
    ...
    <div slot="left-btn">
      ...
      <export-vue
        template-name="proMaintainService"
    ...
    <full-pop
      ...
      @handleClick="handleClick"
    >
      <full-pop-item full-pop-item-title="产品养护记录单">
        <zhqc-form
        ...
        >
          <template v-slot:form-ownerId="scope">
            <list-owner :select-key="topForm.data.ownerId" @select="diaSelectOwner" />
          </template>
          <template v-slot:form-maintainUserId="scope">
...
import proMaintainMixins from './mixins'
...
export default {
  ...
  methods: {
    ...
    diaSelectmaintainUser(data, obj) {
      ...
      this.$set(this.diaFormInfo.data, 'maintainType', obj.maintainType)
