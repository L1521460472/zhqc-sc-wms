    ...
    <div class="sorting-form">
      ...
      <div class="sorting-form-right">
              ...
              <div class="sorting-flex-item sorting-mr-8">
                <el-form-item label="收货件数">
                  <el-input
                    ...
                    type="number"
                    min="0"
                    :disabled="!topForm.data.perQty || topForm.data.perQty < 2 || topForm.data.perQty >= 9999"
                    placeholder="请输入收货件数"
                  />
                </el-form-item>
              </div>
        ...
        <div class="form-right-btn">
          <!--   <el-button @click="nextBatch" type="primary" size="small" :disabled="!multipleBatches">下一批次（F1）
             </el-button>-->
