  ...
  methods: {
    initTopForm() { // 展开收起表单
      this.topForm.fieldList = [
        ...
        { label: this.$t('returnRecAccept.tempControlName'), value: 'tempControlName', type: 'input', disabled: true },
        { label: this.$t('returnRecAccept.commodityQty'), value: 'commodityQty', type: 'input', disabled: true },
        { label: this.$t('returnRecAccept.amount'), value: 'amountY', type: 'input', disabled: true },
        { label: this.$t('returnRecAccept.amountY'), value: 'sumAmountY', type: 'input', disabled: true },
        ...
        { label: this.$t('returnRecAccept.supplierName'), value: 'supplierName', type: 'input', disabled: true },
        { label: this.$t('returnRecAccept.buyer'), value: 'buyer', type: 'input', disabled: true },
        { label: this.$t('returnRecAccept.asnTypeName'), value: 'asnTypeName', type: 'input', disabled: true },
        { label: this.$t('returnRecAccept.remark'), value: 'remark', type: 'input', disabled: true }
      ]
    },
    // 主页面初始化数据
    initPageData() {
      ...
      this.tableInfo1.fieldList = [
        ...
        { prop: 'supplierName', label: this.$t('returnRecAccept.supplierName'), minWidth: 100 },
        { prop: 'buyer', label: this.$t('returnRecAccept.buyer'), minWidth: 100 },
        { prop: 'asnTypeName', label: this.$t('returnRecAccept.asnTypeName'), minWidth: 100 },
        { prop: 'asnSourceName', label: this.$t('returnRecAccept.sourceSys'), minWidth: 100 },
        { prop: 'remark', label: this.$t('returnRecAccept.remark'), minWidth: 100 },
        ...
        { prop: 'tempControlName', label: this.$t('returnRecAccept.tempControlName'), minWidth: 100 },
        { prop: 'amountY', label: this.$t('returnRecAccept.amount'), minWidth: 100 },
        { prop: 'sumAmountY', label: this.$t('returnRecAccept.amountY'), minWidth: 100 }
      ]
