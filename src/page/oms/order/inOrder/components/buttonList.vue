...
<template>
  <div>
    <div style="display: inline-block;margin-left: 5px">
      ...
      <el-button size="mini" type="success" :disabled="!(row.orderStatus === 'ORDER_CREATE' && row.orderOrig ==='SG_CJ')" style="margin-right: 5px" @click="handleClick('openEditPage',row)">编辑</el-button>
      <el-popover placement="bottom" trigger="click">
        <el-button size="mini" type="warning" :disabled="this.$hasPerm('createAsn')" @click="handleClick('handleCreateAsn', row)">下发</el-button>
        ...
        <el-button size="mini" type="danger" :disabled="this.$hasPerm('delete')" @click="handleClick('deleteData', row)">删除</el-button>
