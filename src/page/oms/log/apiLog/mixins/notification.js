...
export default {
  methods: {
     ...
     */
    reboot() {
      this.topForm.data.requestType = null
      this.topForm.data.requestCode = null
      this.topForm.data.createTimeBegin = null
      this.topForm.data.createTimeEnd = null
      this.topForm.data.requestStatus = null
    },
    /**
     * 翻页
     * @param val
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        this.listTypeInfo.requestStatusList = obj.requestStatusList
        this.listTypeInfo.requestTypeList = obj.requestTypeList
      })
    },
    /**
     * 查询表格数据
