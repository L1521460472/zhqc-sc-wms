...
export default {
  methods: {
    ...
    reboot() {
      ...
      this.topForm.data.scOrderType = null
      this.topForm.data.scBusinessType = null
      this.topForm.data.orderOrig = null
      this.topForm.data.orderStatus = null
      this.topForm.data.cusOrderNo = null
      this.topForm.data.customerId = null
      this.topForm.data.confirmTimeFrom = null
      this.topForm.data.confirmTimeTo = null
    ...
    initPage() {
      this.$store.dispatch(this.store + 'initPage', {}).then(() => {
        ...
        if (resp.code === this.$store.state[this.modName].successCode) {
          ...
          this.listTypeInfo.isHasInvoiceList = resp.obj.isHasInvoiceList
