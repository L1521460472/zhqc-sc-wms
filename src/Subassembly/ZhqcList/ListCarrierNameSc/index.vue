...
<template>
  ...
  >
    ...
    >
      <slot>
        <span style="float: left; color: #8492a6; font-size: 13px">{{ item[selectKey] }}</span>
      </slot>
    </el-option>
  </el-select>
</template>
...
export default {
  props: {
    ...
    listUrl: {
      type: String,
      // default: `${process.env.VUE_APP_WMS_MODEL}/carrier/carrier/selectCarrierInfo`
      default: `${VUE_APP_WMS_MODEL}/carrier/carrier/selectCarrierInfo`
    }
  },
  data() {
    return {
