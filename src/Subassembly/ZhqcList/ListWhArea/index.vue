...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/wh/whArea/queryWhAreaCbList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/wh/whArea/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/wh/whArea/queryWhAreaCbList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/wh/whArea/initUpdate/'
    }
  },
  computed: {},
  watch: {
