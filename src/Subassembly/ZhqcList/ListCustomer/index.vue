...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/customer/queryCustomerCbList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/customer/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/partner/customer/queryCustomerCbList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/partner/customer/initUpdate/'
    }
  },
  computed: {},
  watch: {
  ...
  methods: {
    ...
    /**
       ...
       */
    listApi(queryText) {
      const data = { customerCode: queryText, page: this.$globalPage, limit: this.$globalLimit }
      return service({
        url: this.listUrl,
        method: 'post',
        data
