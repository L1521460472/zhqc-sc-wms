...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/store/queryStoreCbList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/store/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/partner/store/queryStoreCbList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/partner/store/initUpdate/'
    }
  },
  computed: {},
  watch: {
  ...
  methods: {
    ...
    /**
       ...
       */
    listApi(queryText) {
      const data = { queryText: queryText, page: this.$globalPage, limit: this.$globalLimit }
      return service({
        url: this.listUrl,
        method: 'post',
        data
    ...
    /**
       ...
       */
    itemApi() {
      console.log(this.selectKey, 'this.slectKey')
      return service({
