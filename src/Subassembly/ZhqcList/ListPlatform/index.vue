...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/tm/platform/queryPlatformCbList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/tm/platform/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/tm/platform/queryPlatformCbList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/tm/platform/initUpdate/'
    }
  },
  computed: {},
  watch: {
  ...
  methods: {
    ...
    listApi(queryText) {
      ...
      const data = { queryText: queryText, platformTypeList: platformTypeList, page: this.$globalPage, limit: this.$globalLimit }
      return service({
        url: this.listUrl,
        method: 'post',
        data
