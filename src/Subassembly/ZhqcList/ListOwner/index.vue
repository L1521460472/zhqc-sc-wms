...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/owner/queryOwnerCbList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/owner/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/partner/owner/queryOwnerCbList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/partner/owner/initUpdate/'
    }
  },
  computed: {},
  watch: {
  ...
  methods: {
    ...
    /**
       ...
       */
    listApi(queryText) {
      const data = { ownerCode: queryText, page: this.$globalPage, limit: this.$globalLimit }
      return service({
        url: this.listUrl,
        method: 'post',
        data
