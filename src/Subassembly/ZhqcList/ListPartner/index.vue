...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/factory/queryFactoryDropDownList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/partner/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/partner/factory/queryFactoryDropDownList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/partner/partner/initUpdate/'
    }
  },
  computed: {},
  watch: {
  ...
  methods: {
    ...
    /**
       ...
       */
    listApi(queryText) {
      const data = { partnerCode: queryText, partnerType: this.partnerType, customerName: '',
