<template>
  ...
  >
    ...
    >
      <slot>
        <span style="float: left; color: #8492a6; font-size: 13px">{{ item.factoryName }}</span>
...
export default {
  ...
  data() {
    return {
      ...
      list: [],
      loading: false,
      // listUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/factory/queryFactoryCbList',
      // itemUrl: process.env.VUE_APP_WMS_MODEL + '/base/partner/factory/initUpdate/'
      listUrl: VUE_APP_WMS_MODEL + '/base/partner/factory/queryFactoryCbList',
      itemUrl: VUE_APP_WMS_MODEL + '/base/partner/factory/initUpdate/'
    }
  },
  computed: {},
  watch: {
  ...
  methods: {
    ...
    /**
       ...
       */
    listApi(queryText) {
      const data = { factoryCode: queryText, page: this.$globalPage, limit: this.$globalLimit }
      return service({
        url: this.listUrl,
        method: 'post',
        data
